        ...
        >
          <GridDX className="bg-background-0 h-full pl-4 pr-4">
            <GridItemDX className="items-center" style={{ marginTop: 103 }}>
              <ImageDX source={require('../assets/logo.png')} alt={'logo'} className="w-182 h-215.09" />
            </GridItemDX>
            ...
            <GridItemDX className="mb-0 mt-5">
              ...
              <GridItemDX className="flex flex-row justify-between items-center w-full m-0 p-0 px-0 mt-1">
                ...
                <LinkDX linkAddress="/forgot-password" linkText="Forgot Password?" className="text-right text-blue-500 text-sm font-normal" />
              </GridItemDX>
            </GridItemDX>

            {/* Login Button */}
            <GridItemDX className="mt-0">
              <ButtonDX variant={'solid'} text="Log In" className="bg-[#E21F26] text-white" onPress={handleLogin} />
              <GridItemDX className="text-center m-0 mt-2 p-0 flex flex-row items-center justify-center">
                ...
                <LinkDX linkAddress="/Signup" linkText="Sign Up" className="ml-1 text-blue-500 text-sm font-normal" />
              </GridItemDX>
            </GridItemDX>
          </GridDX>
        </KeyboardAwareScrollView>
